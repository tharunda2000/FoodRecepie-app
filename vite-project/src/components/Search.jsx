...
const Search = ({setFoodData}) => {
  ...
  return (
    <div className='flex me-10 items-center gap-2'>
      ...
      <i class="ri-home-3-fill  bg-green-600 rounded-full p-1 px-2 cursor-pointer  hover:bg-green-700 text-2xl ms-3"  onClick={()=>{navigate('/')}}></i>
      <i class="ri-account-circle-fill  bg-green-600 rounded-full p-1 px-2 cursor-pointer  hover:bg-green-700 text-2xl"></i>
    </div>
  )
}
