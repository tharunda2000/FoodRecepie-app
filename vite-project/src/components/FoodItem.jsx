  ...
  return (
    <div className=''>
      <div className='bg-green-200 rounded-3xl h-75 sm:h-100'>
        ...
        <div>
          <button className=' mx-3 mt-5 bg-green-400 p-2 hover:bg-green-500 cursor-pointer rounded-full w-30 ' onClick={viewRecepie}>Show Recepie</button>
